Shader "Nate Nesler/uGUI/Lit/Gradient Refraction Detail (Pro Only)"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			void surf (Input IN, inout SurfaceOutput o)
			{
				...
				col *= IN.color;
				col = col.rgba * lerp(_Color2, _Color1, _Gradient + _GradientScale * (_GradientU * IN.texcoord1.x + _GradientV * IN.texcoord1.y)).rgba;
